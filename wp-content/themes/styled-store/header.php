				...
				<?php if( styledstore_check_woocommerce_activation() ) { ?>
					<div class="lgn-ct">
						...
						<div class="header-top-cart mini-cart">
							<a class="cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'styled-store' ); ?>"><?php esc_html_e( 'cart /', 'styled-store' ); echo WC()->cart->get_cart_total(); ?><i class="fa fa-shopping-cart fa-lg" aria-hidden="true"></i>
